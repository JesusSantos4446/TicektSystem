...
var FullCalendar = function(e) {
    ...
    const At = ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"];
    function Dt(e, t) {
        let n = Ht(e);
        return n[2] += 7 * t,
        Bt(n)
    ...
    class bl extends ls {
        ...
        render() {
            let {props: e, state: t, context: n} = this
              ...
              , {singleColPlacements: c, multiColPlacements: d, moreCnts: u, moreMarginTops: h} = ml(di(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells)
